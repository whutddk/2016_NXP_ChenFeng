...
//        冲击华南赛 1车\app\ITAC\freecars.c
//    Command line =  
//        "C:\百度云同步盘\比赛代码\LPLD_OSKinetis_V3\launch\NXP_(golden_cyprinoid)
//        冲击华南赛 1车\app\ITAC\freecars.c" -D LPLD_K60 -lCN
//        "C:\百度云同步盘\比赛代码\LPLD_OSKinetis_V3\launch\NXP_(golden_cyprinoid)
...
//    List file    =  
//        C:\百度云同步盘\比赛代码\LPLD_OSKinetis_V3\launch\NXP_(golden_cyprinoid)
//        冲击华南赛 1车\iar\FLASH\List\freecars.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\百度云同步盘\比赛代码\LPLD_OSKinetis_V3\launch\NXP_(golden_cyprinoid) 冲击华南赛 1车\app\ITAC\freecars.c
//    1 /*
...
//   36   LPLD_UART_PutChar(FreeCarsUARTPort,251);
        MVNS     R1,#+4
        LDR.W    R0,??DataTable4_1  ;; 0x4006d000
...
??sendDataToScope_1:
        MOVS     R1,R5
        SXTB     R1,R1            ;; SignExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable4_1  ;; 0x4006d000
        BL       LPLD_UART_PutChar
//   48 }
...
//  135   ctl.S3010.Kd_S = UartData[2];
        ...
        LDR.N    R1,??DataTable4_6
        STR      R0,[R1, #+32]
//  136   ctl.S3010.Kp_M = UartData[3];
        LDR.N    R2,??DataTable4_4
        LDRD     R0,R1,[R2, #+24]
        BL       __aeabi_d2f
        LDR.N    R1,??DataTable4_6
        STR      R0,[R1, #+24]
//  137   ctl.S3010.Kd_M = UartData[4];
        LDR.N    R2,??DataTable4_4
        LDRD     R0,R1,[R2, #+32]
        BL       __aeabi_d2f
        LDR.N    R1,??DataTable4_6
        STR      R0,[R1, #+36]
//  138   ctl.S3010.Kp_B = UartData[5];
        LDR.N    R2,??DataTable4_4
        LDRD     R0,R1,[R2, #+40]
        BL       __aeabi_d2f
        LDR.N    R1,??DataTable4_6
        STR      R0,[R1, #+28]
//  139   ctl.S3010.Kd_B = UartData[6];
        LDR.N    R2,??DataTable4_4
        LDRD     R0,R1,[R2, #+48]
        BL       __aeabi_d2f
        LDR.N    R1,??DataTable4_6
        STR      R0,[R1, #+40]
//  140 //       ctl.S3010.out = (uint32)UartData[8];
//  141 //  ctl.motto.out = UartData[7];
//  142 
//  143 //  ctl.motto.Kp_S = UartData[7];
//  144 //  ctl.motto.Kd_S = UartData[8];
//  145   
//  146   bz_set(datarec);
        MOVS     R0,#+1
        BL       bz_set
...
//  148 
        ...
        SECTION `.text`:CODE:NOROOT(1)
        THUMB
//  149 void UartCmd(uint8 cmdnum,uint8 cmddata)///
//  150 {
UartCmd:
        PUSH     {R3-R5,LR}
        MOVS     R4,R0
...
??UartCmd_3:
        B.N      ??UartCmd_12
//  157     case(10):break;//F10
??UartCmd_4:
        B.N      ??UartCmd_12
//  158     case(11):break;//F11
??UartCmd_5:
        B.N      ??UartCmd_12
//  159     case(12):break;//F12
??UartCmd_6:
        B.N      ??UartCmd_12
//  160     case(100):break;//PAUSE
??UartCmd_7:
        B.N      ??UartCmd_12
//  161     case(101):flag_stop = 0;break;//HOME
??UartCmd_8:
        MOVS     R0,#+0
        LDR.N    R1,??DataTable4_7
        STRB     R0,[R1, #+0]
        B.N      ??UartCmd_12
//  162     case(102):timer_debug();break;//PG UP
??UartCmd_9:
        BL       timer_debug
        B.N      ??UartCmd_12
//  163     case(103):break;//PF DN
??UartCmd_10:
        B.N      ??UartCmd_12
//  164     case(104):flag_stop = 1;break;//END
??UartCmd_11:
        MOVS     R0,#+1
        LDR.N    R1,??DataTable4_7
        STRB     R0,[R1, #+0]
