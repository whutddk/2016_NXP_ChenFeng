...
void LDC1614_init(void)
{
  ...
  LDC_SEND(REF_COUNT_CH0,0x1770);//转化时间，Conversion Time (tC0) =(CH0_RCOUNT?16)/fREF0
  
  
  LDC_SEND(REF_COUNT_CH1,0x1770);
  
  
  LDC_SEND(REF_COUNT_CH2,0x1770);
  ...
  LDC_SEND(DRIVE_CURRENT_CH0,0xA40);//线圈75*65
  

  
  LDC_SEND(DRIVE_CURRENT_CH1,0x4A40);
  

  
  LDC_SEND(DRIVE_CURRENT_CH2,0x4A40);
  

  
  LDC_SEND(DRIVE_CURRENT_CH3,0x2100);
