...
#define OLED_DO_SET    LPLD_GPIO_Output_b(PTE,28,1)
#define OLED_DO_RESET  LPLD_GPIO_Output_b(PTE,28,0)

#define OLED_DI_SET    LPLD_GPIO_Output_b(PTE,27,1)
#define OLED_DI_RESET  LPLD_GPIO_Output_b(PTE,27,0)

#define OLED_RST_SET    LPLD_GPIO_Output_b(PTE,26,1)
#define OLED_RST_RESET  LPLD_GPIO_Output_b(PTE,26,0)

#define OLED_DC_SET     LPLD_GPIO_Output_b(PTE,25,1)
#define OLED_DC_RESET   LPLD_GPIO_Output_b(PTE,25,0)

#define OLED_CS_SET     LPLD_GPIO_Output_b(PTE,24,1)
#define OLED_CS_RESET   LPLD_GPIO_Output_b(PTE,24,0)
