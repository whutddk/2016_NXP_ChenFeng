...
//    Endian       =  little
//    Source file  =  
//        G:\¿ìÅÌÍøÂç³·Àë\whutddk\·ÉË¼¿¨¶û\LPLDV3.1\LPLD_OSKinetis_V3\project\freescale_cup(DMA)1.0\app\CTL\dirctl.c
//    Command line =  
//        "G:\¿ìÅÌÍøÂç³·Àë\whutddk\·ÉË¼¿¨¶û\LPLDV3.1\LPLD_OSKinetis_V3\project\freescale_cup(DMA)1.0\app\CTL\dirctl.c"
...
//    List file    =  
//        G:\¿ìÅÌÍøÂç³·Àë\whutddk\·ÉË¼¿¨¶û\LPLDV3.1\LPLD_OSKinetis_V3\project\freescale_cup(DMA)1.0\iar\FLASH\List\dirctl.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   22   }
//   23   
//   24   LPLD_FTM_PWM_ChangeDuty(FTM1, FTM_Ch0, (uint32) ctl.S3010.result ); ; //×îºó¿ØÖÆ½á¹ûµÄÊä³ö
??S3010_CTL_2:
        LDR.N    R0,??S3010_CTL_0+0x4
        LDR      R0,[R0, #+20]
        BL       __aeabi_f2uiz
