...
//    Endian       =  little
//    Source file  =  
//        G:\¿ìÅÌÍøÂç³·Àë\whutddk\·ÉË¼¿¨¶û\LPLDV3.1\LPLD_OSKinetis_V3\project\freescale_cup(DMA)1.0\app\CTL\control.c
//    Command line =  
//        "G:\¿ìÅÌÍøÂç³·Àë\whutddk\·ÉË¼¿¨¶û\LPLDV3.1\LPLD_OSKinetis_V3\project\freescale_cup(DMA)1.0\app\CTL\control.c"
...
//    List file    =  
//        G:\¿ìÅÌÍøÂç³·Àë\whutddk\·ÉË¼¿¨¶û\LPLDV3.1\LPLD_OSKinetis_V3\project\freescale_cup(DMA)1.0\iar\FLASH\List\control.s
//
///////////////////////////////////////////////////////////////////////////////
...
//    5 
        ...
        THUMB
//    6 void CTL_SEN_init()//¿ØÖÆ²ÎÊý³õÊ¼»¯
//    7 {
//    8   ctl.S3010.Kp = 0;
CTL_SEN_init:
        MOVS     R0,#+0
...
//   31 //¿ØÖÆÖÐ¶Ïº¯Êý
        ...
        SECTION `.text`:CODE:NOROOT(1)
        THUMB
//   32 void CTL_isr()//¿ØÖÆÏµÍ³µ÷¶È //10ms
//   33 {
CTL_isr:
        PUSH     {R7,LR}
...
//   46       cnt = 0;
        ...
        STRB     R0,[R1, #+0]
//   47       
//   48       motto_getsped();//²âËÙ
        BL       motto_getsped
//   49       ctl_sped();//ËÙ¶È¿ØÖÆ
        BL       ctl_sped
//   50       motto_set();//µç»úÊä³ö    
        BL       motto_set
        B.N      ??CTL_isr_1
//   51     }
//   52     
