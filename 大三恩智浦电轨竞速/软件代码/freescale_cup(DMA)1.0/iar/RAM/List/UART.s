///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.20.2.7424/W32 for ARM       06/Mar/2016  20:36:50
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        D:\LPLDV3.1\LPLD_OSKinetis_V3\project\freescale_cup(DMA)1.0\app\BSP\UART.c
//    Command line =  
//        "D:\LPLDV3.1\LPLD_OSKinetis_V3\project\freescale_cup(DMA)1.0\app\BSP\UART.c"
...
//    List file    =  
//        D:\LPLDV3.1\LPLD_OSKinetis_V3\project\freescale_cup(DMA)1.0\iar\RAM\List\UART.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   10   uart_init_struct.UART_BaudRate = 115200; /*设置波特率(9600)*/
...
//   24   uart_init_struct.UART_Uartx = UART0; //使用UARTx
        ...
        STR      R0,[R1, #+0]
//   25   uart_init_struct.UART_BaudRate = 115200; /*设置波特率(9600)*/
        MOVS     R0,#+115200
        LDR.N    R1,??UART_init_0+0x4
        STR      R0,[R1, #+4]
