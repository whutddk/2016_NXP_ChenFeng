...
{
  LDC_SEND(REF_COUNT_CH0,0x0b54);//转化时间，18ms
  
  
  LDC_SEND(REF_COUNT_CH1,0x0b54);
  
  
  LDC_SEND(REF_COUNT_CH2,0x0b54);
  
  
  LDC_SEND(REF_COUNT_CH3,0x0400);
  ...
  LDC_SEND(SETTLECOUNT_CH0,0x0400);//0x0400数字大保证稳定时间长
  ...
  LDC_SEND(DRIVE_CURRENT_CH0,0x3180);//线圈105*65   18c0 2100 1080
  ...
  LDC_SEND(DRIVE_CURRENT_CH3,0x8800);
