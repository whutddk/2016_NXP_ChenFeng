///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.30.3.8024/W32 for ARM       16/Aug/2016  11:11:12
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        E:\飞思卡尔\新工程\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_LPTMR.c
//    Command line =  
//        E:\飞思卡尔\新工程\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_LPTMR.c -D
//        LPLD_K60 -lCN
...
//  216   LPTMR0->CSR |= LPTMR_CSR_TEN_MASK; 
        ...
        STR      R1,[R2, #+0]
//  217 
//  218   /* 等待计数达到设定值 */while (!(LPTMR0->CSR & LPTMR_CSR_TCF_MASK));
...
//  219   
//  220   /*清除定时比较标志 */
//  221   LPTMR0->CSR &= ~LPTMR_CSR_TEN_MASK;
        LDR.N    R1,??DataTable7_4  ;; 0x40040000
        LDR      R1,[R1, #+0]
        LSRS     R1,R1,#+1
        LSLS     R1,R1,#+1
...
//  226 /*
//  227  * LPTMR中断处理函数
//  228  * 与启动文件startup_K60.s中的中断向量表关联
//  229  * 用户无需修改，程序自动进入对应通道中断函数
//  230  */

        SECTION `.text`:CODE:NOROOT(1)
        THUMB
//  231 void LPT_IRQHandler(void)
//  232 {
LPT_IRQHandler:
        PUSH     {R7,LR}
//  233   LPTMR0->CSR|=LPTMR_CSR_TCF_MASK;  //清除LPT比较标志
        LDR.N    R0,??DataTable7_4  ;; 0x40040000
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x80
        LDR.N    R1,??DataTable7_4  ;; 0x40040000
