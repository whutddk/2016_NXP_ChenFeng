...
uint8_t cat[] = {
,
...
//    }
    ...
    {
      OLED_P8x16Char(ucIdxX+0, ucIdxY, (uint8)j+48);
    }
    else
    {
      OLED_P8x16Str(ucIdxX +0,  ucIdxY, " ");
    }
    
    //个位
    OLED_P8x16Char(ucIdxX+8, ucIdxY, (uint8)k+48);
    
    //小数点
    OLED_P8x16Char(ucIdxX+16, ucIdxY, (uint8) '.' );
    
    
    if ( /*(uint8)f6 != 0 || (uint8)f5 != 0 || (uint8)f4 != 0 || */(uint8)f3 != 0 || (uint8)f2 != 0 || (uint8)f1 != 0 )
    {
      OLED_P8x16Char(ucIdxX+24, ucIdxY, (uint8)f1+48);
    }
    else
    {
      OLED_P8x16Str(ucIdxX+24,  ucIdxY, " ");
    ...
    {
      OLED_P8x16Char(ucIdxX+32, ucIdxY, (uint8)f2+48);
    }
    else
    {
    ...
    {
      OLED_P8x16Char(ucIdxX+40, ucIdxY, (uint8)f3+48);
    }
    else
    {
      OLED_P8x16Str(ucIdxX+40,  ucIdxY, " ");
    }
...
//拟合曲线示波器
/*
void OLED_printosc(int16 data)  //data -160~160    line 0-64  line = 0.39375 * data +64
{
  //attention it's a queue here!
  static int16 osc_line[128] = {0};
  
  //pointer of fifo
  static uint8 fifo = 0;
  
  uint8 i = 0,j = 0;
  osc_line[fifo] = (int16)(0.2 * data + 31);
  ...
  for ( i = 0;i < 8; i++ )
  {
    ...
    for ( j = 0 ; j < 128;j++ )
    {
      if ( osc_line[j] > 63 - 8*i || osc_line[j] <= 55 - 8 * (i))
      {
        OLED_WrDat(0x00);
      }
      else
      {
        OLED_WrDat(0x80 >>  ( osc_line[j] - ( 55 - 8 * i ) -1));
      }
    }
  }
