...
void update_page4()
{
  ...
  if ( GUI.point == 1 )
  {
    OLED_P8x16Str( 50,0,"AI1" );
  }
  else
  {
    OLED_P8x16Str( 0,0,"AI1" );
  }
  if ( GUI.point == 2 )
  {
    OLED_P8x16Str( 50,2,"AI2" );
  }
  else
  {
    OLED_P8x16Str( 0,2,"AI2" );
  }
  if ( GUI.point == 3 )
  {
    OLED_P8x16Str( 50,4,"AI3" );
  }
  else
  {
    OLED_P8x16Str( 0,4,"AI3" );
  }
  if ( GUI.point == 4 )
  {
    OLED_P8x16Str( 50,6,"AI4" );
  }
  else
  {
    OLED_P8x16Str( 0,6,"AI4" );
  }
}
