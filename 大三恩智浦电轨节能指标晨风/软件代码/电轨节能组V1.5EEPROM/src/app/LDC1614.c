...
void LDC1614_init(void)
{
  ...
  LDC_SEND(MUX_CONFIG,0xc209);//修改脉冲滤波，，大于传感器最大频率0xc201
  
  LDC_SEND(DRIVE_CURRENT_CH0,0x4200);//线圈105*652940
  ...
  LDC_SEND(DRIVE_CURRENT_CH2,0x4200);
